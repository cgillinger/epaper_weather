...
class EPaperWeatherApp:
    ...
    def render_weather_layout(self):
        ...
        # RETURNERA VÄDERDATA för jämförelse
        return weather_data
    ...
    def run_weather_app(self):
        ...
        try:
            ...
            # STEG 2: Rendera väder-layout med alla datakällor (hämtar alltid data)
            weather_data = self.render_weather_layout()
            ...
            if should_update:
                ...
                # BEHÅLL SKÄRM: Inga förändringar
                self.logger.info(f"💤 BEHÅLLER E-Paper skärm: {reason}")
                self.display_canvas(force_update=False)
