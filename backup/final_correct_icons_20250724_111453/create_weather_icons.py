...
class WeatherIconsPNGGenerator:
    ...
    def __init__(self, font_path="assets/fonts/weathericons-regular-webfont.ttf"):
        ...
        self.weather_icons_unicode = {
            ...
            # Riktning-ikoner (förbättrade för E-Paper synlighet)
            "wi-direction-up": "\uf058",      # Pil upp
            "wi-direction-down": "\uf044",    # Pil ner  
            "wi-direction-right": "\uf04d",   # Pil höger
            "wi-barometer-up": "\uf058",      # Alternativ för stigande tryck
            "wi-barometer-down": "\uf044",    # Alternativ för fallande tryck
            "wi-barometer-steady": "\uf04d",  # Alternativ för stabilt tryck
            "wi-minus": "\uf056",
            
            # Sol-ikoner (tydligt skiljbara för E-Paper)
            "wi-sunrise": "\uf051",        # Soluppgång med horisont
            "wi-sunset": "\uf052",         # Solnedgång med horisont
            
            # Klockikoner
            "wi-time-1": "\uf08a",         # Analog klocka
            "wi-time": "\uf017",           # Alternativ klockikon
            
            # Instrument-ikoner (barometer, termometer, etc)
            "wi-barometer": "\uf079",         # Barometer-instrument  
            "wi-thermometer": "\uf055",       # Termometer
            "wi-humidity": "\uf07a",          # Luftfuktighet
            "wi-gauge": "\uf079",             # Generisk mätare (samma som barometer)
        ...
        self.size_config = {
            ...
            'pressure': [24, 20],         # Tryckikoner (större för bättre synlighet)
            'sun': [32, 24],              # Sol-ikoner (större för bättre synlighet)
