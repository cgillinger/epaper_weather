#!/usr/bin/env python3
"""
E-Paper Väderapp - Med riktiga väderdata från SMHI + Weather Icons + Exakta soltider
Raspberry Pi 3B + Waveshare 4.26" E-Paper HAT (800×480)
UPPDATERAD: Exakta soltider från ipgeolocation.io API via SunCalculator
"""
...
class EPaperWeatherApp:
    """Huvudklass för E-Paper väderapp med Weather Icons och exakta soltider"""
    
    def __init__(self, config_path="config.json"):
        """Initialisera appen med konfiguration och ikon-hantering"""
        print("🌤️ E-Paper Väderapp med Weather Icons + Exakta soltider - Startar...")
        ...
        # Initialisera weather client (nu med SunCalculator)
        ...
        print("✅ E-Paper Väderapp med exakta soltider initialiserad!")
    ...
    def parse_sun_data_from_weather(self, weather_data: Dict) -> tuple:
        """
        NYTT: Parsea soldata från weather_client och skapa soldata för ikon-manager
    ...
    def render_weather_layout(self):
        """Rendera layout med riktiga väderdata OCH ikoner OCH exakta soltider"""
        self.clear_canvas()
        
        # Hämta riktiga väderdata INKLUSIVE exakta soltider
        self.logger.info("🌐 Hämtar aktuella väderdata med exakta soltider...")
        weather_data = self.weather_client.get_current_weather()
        
        # NYTT: Parsea exakta soltider från weather_client
        ...
        for module_name, module_config in modules.items():
            if module_config['enabled']:
                ...
                # Rita innehåll för varje modul MED IKONER OCH EXAKTA SOLTIDER
                if module_name == 'main_weather':
                    ...
                    # Trycktrend (bara text, ingen pil)
                    if pressure > 1020:
                        trend_text = "Högtryck"
                    elif pressure < 1000:
                        trend_text = "Lågtryck"
                    ...
                    # Imorgon väderikon (placerad till höger om titel)
                    ...
                    # Väderbeskrivning - ENDAST EN GÅNG!
        ...
        self.logger.info("🎨 Layout renderad med Weather Icons och exakta soltider")
        
        # Debug: Visa cache-statistik
        cache_stats = self.icon_manager.get_cache_stats()
        self.logger.info(f"💾 Ikon-cache: {cache_stats['total_cached_icons']} ikoner totalt")
        
        # NYTT: Visa soldata-statistik
    ...
    def run_weather_app(self):
        """Kör väderapp med riktiga data OCH ikoner OCH exakta soltider"""
        try:
            self.logger.info("🌤️ Startar E-Paper väderapp med exakta soltider...")
            
            # Rendera väder-layout med ikoner och exakta soltider
            ...
            print("\n" + "="*60)
            print("✅ E-PAPER VÄDERAPP MED EXAKTA SOLTIDER!")
            ...
            print("🌙 Dag/natt-ikoner baserat på verkliga soltider")
            print("🔧 UPGRADE: Precision från förenklad → exakt algoritm")
            print("="*60)
...
def main():
    ...
    app = None
    try:
        # Skapa och kör väderapp med ikoner och exakta soltider
