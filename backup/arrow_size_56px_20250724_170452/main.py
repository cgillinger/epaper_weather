        ...
        for module_name, module_config in modules.items():
            if module_config['enabled']:
                ...
                if module_name == 'main_weather':
                    ...
                    # TREND-PIL från Weather Icons - I höjd med "Samlar" texten
                    trend_icon = self.icon_manager.get_pressure_icon(trend_arrow, size=(48, 48))  # STÖRRE pil med ring
                    if trend_icon:
                        # Höger sida av modulen, i höjd med "Samlar" texten
                        trend_x = x + width - 60  # 60px från höger kant
                        trend_y = y + 115  # Några pixlar högre än "Samlar" texten
