            ...
            for module_name, module_config in modules.items():
                if module_config['enabled']:
                    ...
                    if module_name == 'main_weather':
                        ...
                        # FIXAD DATUMMODUL - Justerad storlek för bättre läsbarhet
                        now = datetime.now()
                        ...
                        # BORTTAGET: Dekorativ linje (tar onödig plats och gör det rörigt)
                        # Inget behov av linje - modulramen räcker för avgränsning
